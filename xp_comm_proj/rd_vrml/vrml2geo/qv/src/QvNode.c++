...
QvNode::~QvNode()
{
	fprintf(stderr,"QvNode destructor\n");fflush(stderr);
    if (! !(*objName))
...
/*
void QvNode::setGeomObject(geom_objects &geoms)
{
	this->geometries=&geoms;
	fprintf(stderr,"QvNode::setGeomObject geometries = %lp\n",geometries);
	fflush(stderr);
}
*/
