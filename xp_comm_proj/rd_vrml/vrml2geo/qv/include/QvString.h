...
class QvString {
  public:
    ...
    inline friend int		operator ==(const QvString &str, const char *s);
   
    inline friend int		operator ==(const char *s, const QvString &str)
	{ return (str == s); }
    
    inline friend int		operator ==(const QvString &str1, const QvString &str2)
	{ return (str1 == str2.string); }
    inline friend int		operator !=(const QvString &str, const char *s);
    
    inline friend int		operator !=(const char *s, const QvString &str)
	{ return (str != s); }
    inline friend int		operator !=(const QvString &str1,
				    const QvString &str2)
	{ return (str1 != str2.string); }
...
class QvName {
  public:
    ...
    inline friend int		operator ==(const QvName &n, const char *s)
	{ return n.entry->isEqual(s); }
    inline friend int		operator ==(const char *s, const QvName &n)
	{ return n.entry->isEqual(s); }
    
    inline friend int 		operator ==(const QvName &n1, const QvName &n2)
