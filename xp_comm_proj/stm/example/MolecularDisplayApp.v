APPS.SingleWindowApp MolDisplay {
   UI {
      shell {
         x = 87;
         y = 414;
      ...
      status_bar<NEscalingFactor=0.8945946097,NExOffset=-5.,NEyOffset=20.05740166,NEx=297.,NEy=132.> {
         y<NEwidth=440.,NEheight=132.>;
         parent<NEx=22.,NEy=88.>;
         UIframe {
            active = 1;
         };
         ChangeBar<NEx=220.,NEy=242.>;
      };
      InfoBar<NEx=429.,NEy=121.>;
   };
...
26.07};
            ...
            Xform {
               mat = {
                  -0.704758,0.321338,-0.424442,0.,0.512054,0.601805,-0.394615,
0.,0.145633,-0.560948,-0.666498,0.,0.,0.,0.,1.
               };
               ocenter = {0.349,0.5925,-1.0035};
               dcenter = {0.308247,0.523313,
-0.886319};
               xlate = {-0.308247,-0.523313,
0.886319};
               center = {0.349,0.5925,-1.0035};
            };
            Modes {
               outline = "Off";
            };
            ...
            LightXform = {
               {
                  mat=
                  {
                     0.48194,0.796187,-0.365817,0.,-0.343876,0.555876,0.756803,
0.,0.805907,-0.238937,0.541688,0.,0.,0.,0.,1.
                  }
               },
               {
                  mat=
