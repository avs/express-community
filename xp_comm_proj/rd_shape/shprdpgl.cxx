...
int
ReadShape_ReadShapeMods_ReadShapePolygonAsLine::ReadShapePolygonAsLine(OMevent_mask event_mask, int seq_num)
{
   ...
   ERRverror("",ERR_NO_HEADER | ERR_PRINT,
             "I'm in method: ReadShapePolygonAsLine::ReadShapePolygonAsLine\n");
#endif
   ...
   if (ShapeType != (int) XP_GIS_POLYGON_SHAPE)
   {
     ERRverror("",ERR_NO_HEADER | ERR_PRINT,
   ...
   if (FeatureNumber.valid_obj())
   {
     ...
     if (ShapeFile.GetPolygonShapeInfo(&RecordNumber,
