...
extern int TRSIZE;
extern int *permute;
extern monchain_t *mchain;
extern vertexchain_t *vert;
extern int *mon;
extern int *visited;
extern node_t *qs;		/* Query structure */
extern trap_t *tr;		/* Trapezoid structure */
extern segment_t *seg;		/* Segment table */
