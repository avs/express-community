...
{
	macro  ReadVRMLUI {
		XP_COMM_PROJ.ReadVRML1.ReadVRMLMods.ReadVRMLParams+IPort2 & params;
	...
	macro  ReadVRMLFunc {
		XP_COMM_PROJ.ReadVRML1.ReadVRMLMods.ReadVRMLParams+IPort2 &params;
		XP_COMM_PROJ.ReadVRML1.ReadVRMLMods.ReadVRMLCore ReadVRMLCore {
			Filename => <-.params.filename;
	...
	macro  ReadVRML {
		XP_COMM_PROJ.ReadVRML1.ReadVRMLMods.ReadVRMLParams params
		{
			Subdivision = 20;
		};
		XP_COMM_PROJ.ReadVRML1.ReadVRMLMacs.ReadVRMLUI ReadVRMLUI {
			params => <-.params;
		};
		XP_COMM_PROJ.ReadVRML1.ReadVRMLMacs.ReadVRMLFunc ReadVRMLFunc {
			params => <-.params;
		};
