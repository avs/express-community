...
flibrary MiscWidgets <compile_subs=0> {
   ...
   macro random_num {
      ...
      XP_COMM_PROJ.Common.CommonMods.RandomNumCore RandomNumCore {
      ...
      XP_COMM_PROJ.Common.UIWidgets.IAC_StandardUI IAC_StandardUI {
         ...
         XP_COMM_PROJ.Common.CommonMods.RandomNumParams &RandomNumParams<NEportLevels={2,1}> => <-.RandomNumParams;
