...
flibrary UIWidgets <compile_subs=0> {
   ...
   macro VideoControl {
      ...
      UIbutton ResetUIbutton<NEx=187.,NEy=121.> {
         ...
         label => "";
         labelPixmap {
            filename<NEdisplayMode="open"> = "xp_comm_proj/common/lend.xbm";
         };
      ...
      UIbutton PlayBackUIbutton<NEx=341.,NEy=121.> {
         ...
         label => "";
         labelPixmap {
            filename<NEdisplayMode="open"> = "xp_comm_proj/common/lplay.xbm";
         };
      ...
      UIbutton StepBackUIbutton<NEx=495.,NEy=121.> {
         ...
         label => "";
         labelPixmap {
            filename<NEdisplayMode="open"> = "xp_comm_proj/common/larrow.xbm";
         };
      ...
      UIbutton StopUIbutton<NEx=649.,NEy=121.> {
         ...
         label => "";
         labelPixmap {
            filename<NEdisplayMode="open"> = "xp_comm_proj/common/stop.xbm";
         };
      ...
      UIbutton StepUIbutton<NEx=341.,NEy=165.> {
         ...
         label => "";
         labelPixmap {
            filename<NEdisplayMode="open"> = "xp_comm_proj/common/rarrow.xbm";
         };
      ...
      UIbutton PlayUIbutton<NEx=495.,NEy=165.> {
         ...
         label => "";
         labelPixmap {
            filename<NEdisplayMode="open"> = "xp_comm_proj/common/rplay.xbm";
         };
         do<NEportLevels={2,2}> => <-.VideoLoopParams.run;
      };
      ...
      UIbutton ResetBackUIbutton<NEx=649.,NEy=165.> {
         ...
         label => "";
         labelPixmap {
            filename<NEdisplayMode="open"> = "xp_comm_proj/common/rend.xbm";
         };
