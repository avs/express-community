...
int Region_RegionGrowMods_RegionGrowCore::update(OMevent_mask event_mask, int seq_num)
{
	...
	grow_region * grow;
	short* s_in_node_data;
	int*  i_in_node_data;
	float* f_in_node_data;
	double* d_in_node_data;
	int  in_data_comp;
	...
	#ifdef DEBUG
		ERRverror("",ERR_NO_HEADER | ERR_PRINT,"I'm starting method: Region_RegionGrowMods_RegionGrowCore::update\n");
		fprintf(stderr,"I'm starting method: Region_RegionGrowMods_RegionGrowCore::update\n");
		fflush (stderr);
	#endif
	...
	grow = new grow_region(comp,grow_dims,in_data);
	...
	#ifdef DEBUG
		ERRverror("",ERR_NO_HEADER | ERR_PRINT,"I'm in method: Region_RegionGrowMods_RegionGrowCore::update\n");
	#endif
	...
	int* out_node_data = (int*)out.node_data[0].values.ret_typed_array_ptr(OM_GET_ARRAY_WR, DTYPE_INT,&out_data_size);
...
#ifdef DEBUG
		fprintf(stderr,"exit RegionGrowCore\n");
		fflush (stderr);
#endif	
