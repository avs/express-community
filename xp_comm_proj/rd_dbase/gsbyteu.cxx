...
DBF_ByteUtil_c::DBF_ByteUtil_c(const DBF_ByteUtil_c &object)
{
    *this = object;
}
...
DBF_ByteUtil_c &DBF_ByteUtil_c::operator=(const DBF_ByteUtil_c &object)
{
...
//
//  Returns one of:
//     DBF_ByteUtil_c::BIG_ENDIAN  
//     DBF_ByteUtil_c::LITLE_ENDIAN
//

unsigned char DBF_ByteUtil_c::ByteOrder()
{
    return _ByteOrder;
}
...
void *DBF_ByteUtil_c::SwapBytes2(unsigned long  NumberOfBytes,
                                 void          *SwapBuffer)
{
...
void *DBF_ByteUtil_c::SwapBytes4(unsigned long  NumberOfBytes,
                                 void          *SwapBuffer)
{
    unsigned long  k1;           // loop counter
    unsigned char *ByteArray;    // ptr to array of bytes to swap
...
void *DBF_ByteUtil_c::SwapBytes8(unsigned long  NumberOfBytes,
                                 void          *SwapBuffer)
{
    unsigned long  k1;           // loop counter
    unsigned char *ByteArray;    // ptr to array of bytes to swap
