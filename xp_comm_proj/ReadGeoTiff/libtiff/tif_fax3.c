/* $Header: /cvs/repository/TidalWave/Utility/Modules/GeoTIFF/libtiff/tif_fax3.c,v 1.2 1997/12/25 01:33:56 jmethot Exp $ */
 ...
 */
void
_TIFFFax3fillruns(unsigned char* buf, uint16* runs, uint16* erun, uint32 lastx)
{
