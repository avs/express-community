/* $Header: /cvs/repository/TidalWave/Utility/Modules/GeoTIFF/libtiff/tif_predict.c,v 1.2 1997/12/25 01:31:04 jmethot Exp $ */
...
{
	unsigned int stride = PredictorState(tif)->stride;
	uint16* wp = (uint16*) cp0;
	tsize_t wc = cc / 2;
