...
Implementation of the DXFSolid class, which represents DXF 3D Solid objects.
...
/*****************************************************************************
**********--------   Implementations of "DXFSolid" Methods   --------**********
*****************************************************************************/


/*****************************************************************************
Method:   DXFSolid::Make()
Purpose:  This is the static "virtual constructor" for the DXFSolid class.
	  ...
	  by this function as the start of the definition of a 3D Solid,
	  then an instance of DXFSolid is created, and its attributes
...
Returns:  A pointer to a DXFSolid object (cast to DXFPrim *) if the current
          object was recognized as a DXF 3D Solid, or
	  NULL if it wasn't.
*****************************************************************************/
DXFPrim *DXFSolid::Make(DXFGroup &group, CLIST <DXFLayer> *firstLayer)
{
   DXFPrim *instance = 0;

   if (group.DataCmp("SOLID"))
      instance = new DXFSolid(group, firstLayer);
...
/*****************************************************************************
Method:   DXFSolid::DXFSolid()
Purpose:  A Constructor for the DXFSolid class.  Reads the corner points
...
State:    It is assumed that the file pointer into the DXF file has been
          advanced into the BLOCKS or ENTITIES section.
*****************************************************************************/
DXFSolid::DXFSolid(DXFGroup &group, CLIST <DXFLayer> *firstLayer)
{
   int code;
...
/*****************************************************************************
Method:   DXFSolid::DXFSolid()
Purpose:  Copy constructor for the DXFSolid class.
Params:   f   The DXFSolid object to copy.
State:    ---
*****************************************************************************/
DXFSolid::DXFSolid(const DXFSolid &f)
{
...
/*****************************************************************************
Method:   DXFSolid::GetPoints()
Purpose:  This function gets the vertices associated with this 3D Solid.
...
*****************************************************************************/
int DXFSolid::GetPoints(float *array, int offset)
{
   DXFPoint3D Ax,Ay;
   float X,Y,Z;
   for (int i = 0; i < 4; i++)
