...
flibrary ReadNastranMacs <compile_subs=0>  {
   ...
   macro read_nastran {
      ...
      ReadNastranUI ReadNastranUI {
         ReadNastranParams => <-.ReadNastranParams;
         nastran_output => <-.ReadNastran.nastran_output;
      };


      olink out_mesh => ReadNastran.out_mesh;
      olink out_obj => ReadNastran.out_obj;
   };
   ...
   APPS.SingleWindowApp ReadNastranEg {
      GDM.Uviewer3D Uviewer3D {
         Scene {
            Top {
               child_objs => {read_nastran.out_obj};
            };
         };
      };

      read_nastran read_nastran;
